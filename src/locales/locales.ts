...
export const loadLocalization = () => ({
  plugins: {
    ...
    SatellitePlugin: {
      bottomIconLabel: t7e('plugins.SatellitePlugin.bottomIconLabel'),
      title: t7e('plugins.SettingsMenuPlugin.title'),
      helpBody: t7e('plugins.SettingsMenuPlugin.helpBody'),
    },
    ImportConstellationPlugin: {
      bottomIconLabel: t7e('plugins.ImportConstellationPlugin.bottomIconLabel'),
      title: t7e('plugins.SettingsMenuPlugin.title'),
      helpBody: t7e('plugins.SettingsMenuPlugin.helpBody'),
    },
    LoadSetPlugin: {
      bottomIconLabel: t7e('plugins.LoadSetPlugin.bottomIconLabel'),
      title: t7e('plugins.SettingsMenuPlugin.title'),
      helpBody: t7e('plugins.SettingsMenuPlugin.helpBody'),
    },
    GroundTargetPlugin: {
      bottomIconLabel: t7e('plugins.GroundTargetPlugin.bottomIconLabel'),
      title: t7e('plugins.SettingsMenuPlugin.title'),
      helpBody: t7e('plugins.SettingsMenuPlugin.helpBody'),
    },
    ConstellationDeclineSimulationPlugin: {
      bottomIconLabel: t7e('plugins.ConstellationDeclineSimulationPlugin.bottomIconLabel'),
      title: t7e('plugins.SettingsMenuPlugin.title'),
      helpBody: t7e('plugins.SettingsMenuPlugin.helpBody'),
    },
    AlgorithmModelPlugin: {
      bottomIconLabel: t7e('plugins.AlgorithmModelPlugin.bottomIconLabel'),
      title: t7e('plugins.AlgorithmModelPlugin.title'),
      helpBody: t7e('plugins.AlgorithmModelPlugin.helpBody'),
    },
    GraphicsMenuPlugin: {
