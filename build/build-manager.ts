...
class BuildManager {
  ...
  static build() {
    try {
      ...
      // Update login.html with environment variables
      if (config.TIANXUN_SERVER_LOGIN) {
        fileManager.updateLoginHtml('./public/login.html', './dist/login.html', config.TIANXUN_SERVER_LOGIN);
      }
