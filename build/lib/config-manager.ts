...
export class ConfigManager {
  ...
  private loadEnvironmentVariables(envVars: Record<string, string>): void {
    ...
    this.config.TIANXUN_SERVER_LOGIN = process.env.TIANXUN_SERVER_LOGIN ?? envVars.TIANXUN_SERVER_LOGIN;
    this.config.TIANXUN_SERVER_SETTINGS = process.env.TIANXUN_SERVER_SETTINGS ?? envVars.TIANXUN_SERVER_SETTINGS;
